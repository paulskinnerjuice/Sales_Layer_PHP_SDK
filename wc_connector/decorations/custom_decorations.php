...
class Custom_Decorations
{
    ...
    public function decorate_product_for_wc($individual_product)
    {
        ...
        $getProd = $this->db->query('SELECT * FROM pim_wc_connection WHERE pim_id = ' . $id . ' LIMIT 1');
    ...
    public function add_decorated_product_format_to_product($individual_format, $formatted_product, $attr_count, $format_count)
    {
        ...
        $this->wc->put('products/' . $product_id, $attr_to_wc);
